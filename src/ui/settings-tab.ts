...
export class IOTOUpdateSettingTab extends PluginSettingTab {
	...
	private appendRepoIcons(setting: Setting, entry: IOTOPluginEntry) {
		...
		githubLink.createEl("span", { text: "GitHub" });

		// Gitee 链接（Gitee 品牌色 + Gitee logo）
		...
		giteeLink.insertAdjacentHTML(
			"beforeend",
			'<svg viewBox="0 0 24 24" width="14" height="14" fill="currentColor" aria-hidden="true"><path d="M11.984 0A12.02 12.02 0 0 0 0 12.02C0 18.63 5.365 24 11.984 24A12.02 12.02 0 0 0 24 12.02C24 5.365 18.63 0 11.984 0zm7.094 14.871a3.034 3.034 0 0 1-3.035 3.035H8.062a3.034 3.034 0 0 1-3.035-3.035V9.13a3.034 3.034 0 0 1 3.035-3.035h7.98a3.034 3.034 0 0 1 3.035 3.035z"/></svg>',
		);
		giteeLink.createEl("span", { text: "Gitee" });
	}
